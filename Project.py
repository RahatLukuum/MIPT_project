...
class Game:
    '''Класс игры, имеющего поля: ширина экрана, высота экрана, параметр хода игры, вводимый текст, индекс символа, счетчик символов,
    счетчик ошибок, время начала, время игры, результаты, инструкцию, измеритель скорости набора текста, параметр завершения игры,
    цвет текста для шапки, цвет текста для инструкции, цвет текста для результатов'''
    def __init__(self):
        self.w = 1000
        self.h = 750
        self.active = False
